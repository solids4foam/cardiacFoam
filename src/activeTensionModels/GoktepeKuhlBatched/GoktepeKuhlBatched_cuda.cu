...
Description
    CUDA launch wrappers for GoktepeKuhl batched tension model.
...
namespace
{
    ...
    __global__ void goktepeKuhlBatchKernel
    (
...
void launchGoktepeKuhlBatchKernel
(
...
{
    goktepeKuhlBatchKernel<<<nBlocks(N), blockSize>>>
    (
        d_driveSignals,
        d_CONSTANTS,
        N,
