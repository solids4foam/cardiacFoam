...
autoPtr<myocardialDomainModel> newMonodomainMyocardiumDomain
(
    const fvMesh& mesh,
...
{
    return autoPtr<myocardialDomainModel>
    (
        ...
        (
            ...
            electroProperties,
            config,
            autoPtr<reactionDiffusionSolver>
            (
                new MonoDomainDiffusionSolver(mesh, electroProperties)
            )
        )
    );
}
...
autoPtr<myocardialDomainModel> newBidomainMyocardiumDomain
(
    const fvMesh& mesh,
    const dictionary& electroProperties,
    volScalarField& phiE,
...
)
{
    ...
    (
        ...
        (
            ...
            autoPtr<reactionDiffusionSolver>
            (
                new BiDomainDiffusionSolver(mesh, electroProperties, phiE)
            ),
            &phiE
        )
    );
...
void configureMonodomainSystem
(
