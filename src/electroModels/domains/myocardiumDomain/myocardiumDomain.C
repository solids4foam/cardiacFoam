...
(
    ...
    autoPtr<reactionDiffusionSolver> diffusionSolverPtr,
    volScalarField* phiEPtr
)
:
    myocardialDomainModel(mesh),
    ...
    outFields_(config.outFields),
    preProcessFieldNames_(),
    preProcessFields_(),
    postProcessFieldNames_(config.postProcessFieldNames),
    postProcessFields_(config.postProcessFields),
    ionicModel_(config.ionicModel),
    verificationModelPtr_(config.verificationModelPtr),
