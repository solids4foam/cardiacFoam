    ...
    RATES_(num)
{
    ...
    Info<< nl << "Calling Trovato initConsts" << endl;
    forAll(STATES_, i)
    {
...
void Foam::Trovato::calculateCurrent
(
...
{
    // Must match NUM_ALGEBRAIC from the generated Trovato code
...
void Foam::Trovato::updateStatesOld(const Field<Field<scalar>>&) const
{
    saveStateSnapshot(STATES_, STATES_OLD_);
}

void Foam::Trovato::resetStatesToStatesOld(Field<Field<scalar>>&) const
{
...
Foam::wordList Foam::Trovato::exportedFieldNames() const
    {
    ...
    Foam::wordList Foam::Trovato::debugPrintedNames() const
    {
        return ionicModelIO::exportedFieldNames
        (
            debugVarNames_,
...
void Foam::Trovato::exportStates
(
...
void Foam::Trovato::debugPrintFields
(
    label cellI,
    scalar t1,
    scalar t2,
...
void Foam::Trovato::writeHeader(OFstream& os) const
{
...
static Foam::scalar Trovato_vm(const Foam::scalarField& S)
{
    return S[0];
}

void Foam::Trovato::write(const scalar t, OFstream& os) const
{
    const wordList names = exportedFieldNames();
