...
namespace
{
    ...
    __global__ void buenoBatchKernel
    (
        const double t,
    ...
    __global__ void buenoEulerStepKernel
    (
    ...
    __global__ void buenoScaleIonKernel
    (
...
{
    buenoEulerStepKernel<<<nBlocks(N), blockSize>>>
    (
        d_STATES, d_RATES, dt,
...
{
    buenoScaleIonKernel<<<nBlocks(N), blockSize>>>
    (
