...
def resolve_paths(*, project_root: Path) -> RepoPaths:
    ...
    return RepoPaths(
        ...
        diffusivity_config=scripts_root / "diffusivity" / "config_diffusivity.py",
        scar_config=scripts_root / "scar" / "config_scar.py",
        purkinje_slab_config=scripts_root / "purkinje" / "slab" / "config_slab.py",
        purkinje_fractal_config=scripts_root / "purkinje" / "fractal_3d" / "config_fractal.py",
        purkinje_fractal_runner=scripts_root / "purkinje" / "fractal_3d" / "fractal.py",
