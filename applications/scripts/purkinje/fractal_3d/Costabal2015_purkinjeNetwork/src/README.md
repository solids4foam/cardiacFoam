...
This is the upstream fractal-tree library vendored for the Purkinje generator.
In this repo, it is used by `fractalTree_purkinjeNetwork.py` in the parent folder.
