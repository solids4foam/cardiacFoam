...
from .manufactured_monodomain_pseudo_ecg import (
    ...
    DT_VALUES,
    ECG_ELECTRODES_BY_DIMENSION as _BASE_ECG_ELECTRODES_BY_DIMENSION,
    NUMBER_CELLS,
    OUTPUT_DIR_NAME,
    PIECEWISE_SWEEP,
...
TUTORIAL_NAME = "manufacturedRotatedAnisotropy"
CASE_DIR_NAME = "manufacturedSolutions/monodomainRotatedAnisotropy"
...
# The tutorial's own ecgDomains.ECG block has no 'manufactured' sub-dict
# (electrode positions are already baked in): this verifier doesn't use
# pseudoECG's own quadrature-order verification, so leave it uninjected.
ECG_ENABLED = False
ECG_REFERENCE_QUADRATURE_ORDER = 96
ECG_CHECK_QUADRATURE_ORDERS = (6, 12, 24, 48)
ECG_ELECTRODES_BY_DIMENSION = {"3D": _BASE_ECG_ELECTRODES_BY_DIMENSION["3D"]}
