...
IONIC_MODEL_CATALOG: Final[dict[str, IonicModelEntry]] = {
    ...
    "BuenoOrovio": IonicModelEntry(
        ...
        cardiac_region=("ventricle",),
        model_type="phenomenological",
        description="Four-variable phenomenological model reproducing better AP morphology than AlievPanfilov; specifically parameterised for human ventricular action potentials (Bueno-Orovio et al. 2008). Computationally cheap. No ion dynamics. Compatible with epicardial, M-cell, and endocardial tissue variants. Dimensionless units.",
    ...
    "Gaur": IonicModelEntry(
        ...
        cardiac_region=("ventricle",),
        model_type="ionic",
        description="Pig ventricular ionic model (Gaur et al. 2021). Use when pig animal experiments are the reference. Features 29 states including a two-step calcium release process. Computationally moderate.",
        aliases=("Gaur 2021", "pig ventricular model"),
        recommended_ode_step=1e-5,
        recommended_stimulus_duration=0.002,
        recommended_stimulus_intensity=80000.0,
    ),
    "Grandi": IonicModelEntry(
        ...
        cardiac_region=("atrium",),
        model_type="ionic",
        description="Human atrial ionic model with detailed calcium signalling and electrolytes (Grandi et al. 2011). 41 states. Suited for Ca²⁺ handling and atrial fibrillation drug studies. Computationally demanding.",
        aliases=("Grandi 2011", "human atrial model"),
        recommended_ode_step=1e-5,
        recommended_stimulus_duration=0.002,
        recommended_stimulus_intensity=80000.0,
    ),
    "Stewart": IonicModelEntry(
        ...
        model_type="ionic",
        description="Human Purkinje fibre ionic model for specialised cardiac conduction (Stewart et al. 2009). 20 states. Computationally moderate. Use with monodomain1DSolver for Purkinje network simulations. Not a ventricular myocyte model — do not use for ventricular tissue simulations.",
    ...
    "TNNP": IonicModelEntry(
        ...
        cardiac_region=("ventricle",),
        model_type="ionic",
        description="Ten Tusscher-Noble-Noble-Panfilov; widely used 17-state human ventricular ionic model (ten Tusscher et al. 2004). Well-validated for 3-D reentry and drug screening. Tissue variants: epicardial, M-cell, endocardial. Computationally moderate.",
        aliases=("ten Tusscher", "TT04"),
        recommended_ode_step=1e-5,
        recommended_stimulus_duration=0.002,
    ...
    "ToRORd_dynCl": IonicModelEntry(
        ...
        cardiac_region=("ventricle",),
        model_type="ionic",
        description="Evolution of ORd with dynamic chloride handling; 45 states (Tomek et al. 2020). Suited for studies involving chloride currents or arrhythmia. Computationally demanding.",
        aliases=("ToR-ORd-dynCl", "Tomek", "ToRORd", "Tomek-Rodriguez-ORd", "dynamic chloride"),
        recommended_ode_step=1e-5,
        recommended_stimulus_duration=0.002,
        recommended_stimulus_intensity=80000.0,
    ),
    "Trovato": IonicModelEntry(
        ...
        cardiac_region=("purkinje",),
        model_type="ionic",
        description="Human Purkinje cell model for investigating early after-depolarisations (EADs); 46 states (Trovato et al. 2020). Computationally demanding. Use for EAD and triggered activity studies in specialized conduction systems.",
        aliases=("Trovato 2020", "Purkinje EAD model"),
        recommended_ode_step=1e-5,
        recommended_stimulus_duration=0.002,
        recommended_stimulus_intensity=80000.0,
    ),
    ...
    "PerisYague": IonicModelEntry(
        ...
        cardiac_region=("atrium",),
        model_type="ionic",
        description="Pig atrial ionic model with chloride current IClCa; 22 states (Peris-Yaguë et al. 2022). Extension of Courtemanche (CRN98) with Cl⁻ handling and two-component IKur inactivation. Suited for atrial Cl⁻-dependent arrhythmia and drug studies. Computationally moderate.",
