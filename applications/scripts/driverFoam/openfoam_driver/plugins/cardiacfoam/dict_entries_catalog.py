...
ELECTRO_PROPERTY_ENTRY_GROUPS: Final[dict[str, tuple[DictEntry, ...]]] = {
    ...
    "active_tension": build_group(
        ...
        DictEntry(
            ...
            value_kind='enum',
            enum_values=('GoktepeKuhl', 'NashPanfilov', 'LandNiederer', 'LandNiedererTWorld', 'GoktepeKuhlBatched', 'NashPanfilovBatched', 'LandNiedererTWorldBatched', 'ManufacturedElectromechanics'),
        ...
        DictEntry(
            ...
            applicable_when={"activeTensionModel": ("LandNiederer", "LandNiedererTWorld", "LandNiedererTWorldBatched")},
        ),
        ),
    ),
