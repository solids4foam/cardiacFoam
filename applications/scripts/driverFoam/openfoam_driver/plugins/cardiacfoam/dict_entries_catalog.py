...
ELECTRO_PROPERTY_ENTRY_GROUPS: Final[dict[str, tuple[DictEntry, ...]]] = {
    ...
    "batched_integrator": build_group(
        ...
        DictEntry(
            ...
            notes='Read via lookupOrDefault on both sides, but validated: batchedIonicModel.H raises FatalIOError on an unknown value, and batchedActiveTensionModel.C raises FatalIOError both on an unknown value and when rushLarsen is requested for a model that supplies no Rush-Larsen parameters (LandNiedererBatched, LandNiedererTWorldBatched).',
            value_kind='enum',
        ...
        DictEntry(
            ...
            description='Force storing volatile algebraic states in memory for export/debug. Defaults to true for batched ionic and batched active-tension models; setting it false on a model that exports or debug-prints an algebraic (e.g. AV_Ta) is a fatal configuration error.',
            source_refs=('src/ionicModels/ionicModel/batchedIonicModel.H', 'src/activeTensionModels/activeTensionModel/batchedActiveTensionModel.C'),
            value_kind='boolean',
        ),
        ),
    ...
    "ecg": build_group(
        ...
        DictEntry(
            ...
            phases=frozenset({'physics'}),
            description="Tissue selector for the single-cell anchors paced by eikonalECG's personalizedTemplates generator. Nested copy of the top-level selector: eikonalTemplateGenerator.C:341 copies the whole ionicModelConfig dict into the ionic model's own dictionary, so the model reads it by its ordinary name.",
            source_refs=('src/electroModels/ecgModels/eikonalECG/eikonalTemplateGenerator.C', 'src/ionicModels/ionicModel/ionicModel.H'),
            value_kind='enum',
            enum_values=('epicardialCells', 'mCells', 'endocardialCells', 'myocyte'),
            dynamic_path=True,
            applicable_when={"$ELECTRO_MODEL_COEFFS.ecgDomains.<name>.ecgSolver": "eikonalECG"},
        ...
        DictEntry(
            driver_path='$ELECTRO_MODEL_COEFFS.ecgDomains.<name>.personalizedTemplates.ionicModelConfig.solver',
            phases=frozenset({'physics'}),
            description="ODE solver selector for the single-cell anchor runs, passed through to OpenFOAM's ODESolver factory. Scoped to the template generator's nested ionicModelConfig, independent of the outer solver.",
            source_refs=('src/electroModels/ecgModels/eikonalECG/eikonalTemplateGenerator.C', 'src/ionicModels/ionicModel/ionicModel.H'),
            value_kind='enum',
            enum_values=('RKF45', 'Euler'),
            dynamic_path=True,
        ...
        DictEntry(
            driver_path='$ELECTRO_MODEL_COEFFS.ecgDomains.<name>.personalizedTemplates.ionicModelConfig.absTol',
            phases=frozenset({'physics'}),
            description='Absolute tolerance for the adaptive ODE solver used by the single-cell anchor runs.',
            source_refs=('src/electroModels/ecgModels/eikonalECG/eikonalTemplateGenerator.C', 'src/ionicModels/ionicModel/ionicModel.H'),
            value_kind='scalar',
            dynamic_path=True,
            applicable_when={"$ELECTRO_MODEL_COEFFS.ecgDomains.<name>.ecgSolver": "eikonalECG"},
        ...
        DictEntry(
            driver_path='$ELECTRO_MODEL_COEFFS.ecgDomains.<name>.personalizedTemplates.ionicModelConfig.relTol',
            phases=frozenset({'physics'}),
            description='Relative tolerance for the adaptive ODE solver used by the single-cell anchor runs.',
            source_refs=('src/electroModels/ecgModels/eikonalECG/eikonalTemplateGenerator.C', 'src/ionicModels/ionicModel/ionicModel.H'),
            value_kind='scalar',
            dynamic_path=True,
            applicable_when={"$ELECTRO_MODEL_COEFFS.ecgDomains.<name>.ecgSolver": "eikonalECG"},
        ...
        DictEntry(
            driver_path='$ELECTRO_MODEL_COEFFS.ecgDomains.<name>.personalizedTemplates.ionicModelConfig.batchedSubsteps',
            phases=frozenset({'physics'}),
            description='Number of substeps for batched ODE integration inside the single-cell anchor runs. Defaults to 1, which is too coarse for stiff models at the generator dt and has produced SIGFPE in TWorldcompactBatched; raise it for batched models.',
            source_refs=('src/electroModels/ecgModels/eikonalECG/eikonalTemplateGenerator.C', 'src/ionicModels/ionicModel/ionicModel.H'),
            value_kind='integer',
            dynamic_path=True,
            applicable_when={"$ELECTRO_MODEL_COEFFS.ecgDomains.<name>.ecgSolver": "eikonalECG"},
        ...
        DictEntry(
            driver_path='$ELECTRO_MODEL_COEFFS.ecgDomains.<name>.personalizedTemplates.ionicModelConfig.singleCellStimulus.stim_start',
            phases=frozenset({'physics'}),
            description='Start time of the S1 protocol pacing each single-cell anchor.',
            source_refs=('src/electroModels/ecgModels/eikonalECG/eikonalTemplateGenerator.C', 'src/ionicModels/ionicModel/ionicModel.H'),
            value_kind='scalar',
            unit='s',
            dynamic_path=True,
        ...
        DictEntry(
            ...
            phases=frozenset({'physics'}),
            description='S1 pacing cycle length for the single-cell anchor runs.',
            source_refs=('src/electroModels/ecgModels/eikonalECG/eikonalTemplateGenerator.C', 'src/ionicModels/ionicModel/ionicModel.H'),
            value_kind='scalar',
            unit='s',
            dynamic_path=True,
        ...
        DictEntry(
            ...
            phases=frozenset({'physics'}),
            description='Pulse duration for the single-cell anchor stimuli.',
            source_refs=('src/electroModels/ecgModels/eikonalECG/eikonalTemplateGenerator.C', 'src/ionicModels/ionicModel/ionicModel.H'),
            value_kind='scalar',
            unit='s',
            dynamic_path=True,
        ...
        DictEntry(
            ...
            phases=frozenset({'physics'}),
            description="Stimulus current amplitude for the single-cell anchor runs. Magnitude is model-dependent and must be sized for the chosen ionicModel's units, or eikonalTemplateGenerator.C's validateTemplate() amplitude check rejects the template.",
            source_refs=('src/electroModels/ecgModels/eikonalECG/eikonalTemplateGenerator.C', 'src/ionicModels/ionicModel/ionicModel.H'),
            value_kind='scalar',
            dynamic_path=True,
            applicable_when={"$ELECTRO_MODEL_COEFFS.ecgDomains.<name>.ecgSolver": "eikonalECG"},
        ...
        DictEntry(
            ...
            phases=frozenset({'physics'}),
            description='Number of S1 pulses for the single-cell anchor runs. Silently overwritten by personalizedTemplates.nBeats when that is set.',
            source_refs=('src/electroModels/ecgModels/eikonalECG/eikonalTemplateGenerator.C', 'src/ionicModels/ionicModel/ionicModel.H'),
            value_kind='integer',
            dynamic_path=True,
            applicable_when={"$ELECTRO_MODEL_COEFFS.ecgDomains.<name>.ecgSolver": "eikonalECG"},
        ...
        DictEntry(
            driver_path='$ELECTRO_MODEL_COEFFS.ecgDomains.<name>.personalizedTemplates.ionicModelConfig.singleCellStimulus.nstim2',
            phases=frozenset({'physics'}),
            description='Number of S2 pulses for the single-cell anchor runs.',
            source_refs=('src/electroModels/ecgModels/eikonalECG/eikonalTemplateGenerator.C', 'src/ionicModels/ionicModel/ionicModel.H'),
            value_kind='integer',
            dynamic_path=True,
            applicable_when={"$ELECTRO_MODEL_COEFFS.ecgDomains.<name>.ecgSolver": "eikonalECG"},
    ...
    "conduction_system": build_group(
        ...
        DictEntry(
            ...
            phases=frozenset({'stimulus'}),
            description='Start time [s] of a single-firing rootStimulus. Required when the block is present and startTimeList is absent; use startTimeList instead for a multi-beat train.',
            source_refs=('src/electroModels/electroDomains/conductionSystemDomain/conductionSystemDomain.C',),
            value_kind='scalar',
            unit='s',
            dynamic_path=True,
        ...
        DictEntry(
            driver_path='$ELECTRO_MODEL_COEFFS.conductionNetworkDomains.<name>.purkinjeGraphModelCoeffs.rootStimulus.startTimeList',
            phases=frozenset({'stimulus'}),
            description='Firing times [s] for a multi-beat rootStimulus, e.g. (0.01 0.3). Alternative to the scalar startTime; every firing reuses the same duration, intensity and node. Only monodomain1DSolver applies these as injected current — the eikonal 1D solvers see just the earliest entry, through activation-time seeding, and ignore the rest.',
            source_refs=('src/electroModels/electroDomains/conductionSystemDomain/conductionSystemDomain.C',),
            value_kind='scalar_list',
            unit='s',
            dynamic_path=True,
    ...
    "active_tension": build_group(
        ...
        DictEntry(
            ...
            source_refs=('src/activeTensionModels/LandNiederer/LandNiederer.C', 'src/activeTensionModels/LandNiedererTWorld/LandNiedererTWorld.C'),
            value_kind='scalar',
            unit='ms',
            ...
            applicable_when={"activeTensionModel": ("LandNiederer", "LandNiedererBatched", "LandNiedererTWorld", "LandNiedererTWorldBatched")},
        ),
        ),
    ),
