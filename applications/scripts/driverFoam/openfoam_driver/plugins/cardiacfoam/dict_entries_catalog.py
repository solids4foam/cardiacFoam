...
ELECTRO_PROPERTY_ENTRY_GROUPS: Final[dict[str, tuple[DictEntry, ...]]] = {
    ...
    "ecg": build_group(
        ...
        DictEntry(
            ...
            value_kind='enum',
            enum_values=('pseudoECGManufacturedVerifier', 'eikonalECGManufacturedVerifier', 'bathECGManufacturedVerifier'),
            dynamic_path=True,
        ),
        DictEntry(
            driver_path='$ELECTRO_MODEL_COEFFS.ecgDomains.<name>.manufacturedEikonalECG.enabled',
            phases=frozenset({'physics'}),
            description='Enable the eikonal-ECG manufactured verifier. The presence of this sub-dict also selects that verifier.',
            source_refs=('src/verificationModels/ecgVerification/eikonalECGManufacturedVerifier.C',),
            notes='Default true (eikonalECGManufacturedVerifier.C:179). Distinct from the pseudo-ECG `manufactured` block.',
            value_kind='boolean',
            typical_value='yes',
            dynamic_path=True,
        ),
        DictEntry(
            driver_path='$ELECTRO_MODEL_COEFFS.ecgDomains.<name>.manufacturedEikonalECG.referenceQuadratureOrder',
            phases=frozenset({'physics'}),
            description='Quadrature order for the reference eikonal-ECG integral the coarser orders are compared against.',
            source_refs=('src/verificationModels/ecgVerification/eikonalECGManufacturedVerifier.C',),
            notes='Default 96 (eikonalECGManufacturedVerifier.C:220).',
            value_kind='integer',
            typical_value='96',
            dynamic_path=True,
        ),
        DictEntry(
            driver_path='$ELECTRO_MODEL_COEFFS.ecgDomains.<name>.manufacturedEikonalECG.checkQuadratureOrders',
            phases=frozenset({'physics'}),
            description='Quadrature orders to evaluate and compare against the reference, for eikonal-ECG convergence checking.',
            source_refs=('src/verificationModels/ecgVerification/eikonalECGManufacturedVerifier.C',),
            notes='Default (6) (eikonalECGManufacturedVerifier.C:225-230) -- differs from the pseudo-ECG manufactured.checkQuadratureOrders default of (6 12 24 48).',
            value_kind='label_list',
            typical_value='(6 12 24 48 96)',
            dynamic_path=True,
        ),
        ),
    ),
    "bidomain": build_group(
        ...
        DictEntry(
            driver_path='$ELECTRO_MODEL_COEFFS.manufacturedBidomain.k',
            phases=frozenset({'physics'}),
            description='Wave vector parameter of the bidomain manufactured analytical solution.',
            source_refs=('src/verificationModels/bidomainVerification/manufacturedFDABidomainVerifier.C',),
            notes='manufacturedFDABidomainVerifier reads its configuration from the manufacturedBidomain sub-dict (:74), NOT from verificationModel -- the bath-bidomain verifier is the one that uses verificationModel. Mandatory for this verifier: subDict fatals if absent.',
            value_kind='scalar',
            applicable_when={"$ELECTRO_MODEL_COEFFS.verificationModel.type": ("manufacturedFDABidomainVerifier",)},
        ),
        DictEntry(
            driver_path='$ELECTRO_MODEL_COEFFS.manufacturedBidomain.alpha',
            phases=frozenset({'physics'}),
            description='Amplitude parameter of the bidomain manufactured analytical solution.',
            source_refs=('src/verificationModels/bidomainVerification/manufacturedFDABidomainVerifier.C',),
            value_kind='scalar',
            applicable_when={"$ELECTRO_MODEL_COEFFS.verificationModel.type": ("manufacturedFDABidomainVerifier",)},
        ),
        DictEntry(
            driver_path='$ELECTRO_MODEL_COEFFS.manufacturedBidomain.groundElectrode',
            phases=frozenset({'physics'}),
            description='Analytically pin a ground Dirichlet reference for the bidomain manufactured solution.',
            source_refs=('src/verificationModels/bidomainVerification/manufacturedFDABidomainVerifier.C',),
            value_kind='boolean',
            applicable_when={"$ELECTRO_MODEL_COEFFS.verificationModel.type": ("manufacturedFDABidomainVerifier",)},
        ),
        DictEntry(
            driver_path='$ELECTRO_MODEL_COEFFS.manufacturedBidomain.enabled',
            phases=frozenset({'physics'}),
            description='Enable the bidomain manufactured verifier.',
            source_refs=('src/verificationModels/bidomainVerification/manufacturedFDABidomainVerifier.C',),
            value_kind='boolean',
            applicable_when={"$ELECTRO_MODEL_COEFFS.verificationModel.type": ("manufacturedFDABidomainVerifier",)},
        ),
    ...
    "conduction_system": build_group(
        ...
        DictEntry(
            ...
            notes='conductionSystemDomain.C:574 builds it only when a verificationModel sub-dict exists, but graphVerificationModel.C:50 then reads type with get<word> -- so an existing block WITHOUT type is fatal. Unlike the eikonal table there is no "none" escape and no enabled switch: to turn it off, delete the block.',
            value_kind='enum',
