...
DIMENSIONS = ["3D"]
NUMBER_CELLS = [10, 20, 40]
DT_VALUES = [0.00892857, 0.00224215, 0.000560538]
OUTPUT_DIR_NAME = "postProcessing"
OUTPUT_RELPATH = Path("postProcessing")

TUTORIAL_NAME = "manufacturedElectromechanicsBC"
CASE_DIR_NAME = "manufacturedSolutions/electromechanicsBC"
SETUP_DIR_NAME = "setupManufacturedElectromechanicsBC"
...
POSTPROCESS_SCRIPT_RELPATH = Path("post_processing_manufactured_electromechanics.py")
