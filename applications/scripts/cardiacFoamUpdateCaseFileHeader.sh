...
#
# Script
#     cardiacFoamUpdateCaseFileHeader
#     adapted from solids4FoamUpdateCaseFileHeader,
...
#
#     $ find . -name "*" -type f | xargs -n 1 "./cardiacFoamUpdateCaseFileHeader.sh"
#
#     where the address of this script is updated as appropriate.
#
#------------------------------------------------------------------------------
cardiacFoamVersion=v0.1
...
options:
  ...
  By default, writes version ${cardiacFoamVersion} in the header.
