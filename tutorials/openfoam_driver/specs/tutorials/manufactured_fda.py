...
def _apply_case(
    ...
    *,
    ...
    cardiac_properties_relpath: Path = defaults.CARDIAC_PROPERTIES_RELPATH,
    time_integration_properties_relpath: Path = defaults.TIME_INTEGRATION_PROPERTIES_RELPATH,
    ...
    cardiac_properties = case_root / cardiac_properties_relpath
    time_integration_properties = case_root / time_integration_properties_relpath
    ...
    set_cardiac_dimension(cardiac_properties, dimension)
    set_solve_explicit(time_integration_properties, solver)
...
def make_spec(
    *,
    ...
    cardiac_properties_relpath: str | Path = defaults.CARDIAC_PROPERTIES_RELPATH,
    time_integration_properties_relpath: str | Path = defaults.TIME_INTEGRATION_PROPERTIES_RELPATH,
    block_mesh_dict_template: str = defaults.BLOCK_MESH_DICT_TEMPLATE,
    ...
    cardiac_properties_path = Path(cardiac_properties_relpath)
    time_integration_properties_path = Path(time_integration_properties_relpath)
    ...
    return TutorialSpec(
        ...
        apply_case=partial(
            ...
            cardiac_properties_relpath=cardiac_properties_path,
            time_integration_properties_relpath=time_integration_properties_path,
        ...
        metadata={
            ...
            "cardiac_properties_relpath": str(cardiac_properties_path),
            "time_integration_properties_relpath": str(time_integration_properties_path),
            "block_mesh_dict_template": block_mesh_dict_template,
