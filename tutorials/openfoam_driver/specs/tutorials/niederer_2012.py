...
def _apply_case(
    ...
    *,
    ...
    time_integration_props_relpath: Path = defaults.TIME_INTEGRATION_PROPERTIES_RELPATH,
    slab_size_mm: Sequence[float] = defaults.SLAB_SIZE_MM,
    ...
    time_integration_props = case_root / time_integration_props_relpath
    ...
    set_tissue(cardiac_properties, tissue)
    set_ionic_model(cardiac_properties, ionic_model)
    set_solve_explicit(time_integration_props, solver)
...
def make_spec(
    *,
    ...
    time_integration_props_relpath: str | Path = defaults.TIME_INTEGRATION_PROPERTIES_RELPATH,
    ...
    time_integration_props_path = Path(time_integration_props_relpath)
    ...
    return TutorialSpec(
        ...
        apply_case=partial(
            ...
            time_integration_props_relpath=time_integration_props_path,
        ...
        metadata={
            ...
            "time_integration_props_relpath": str(time_integration_props_path),
