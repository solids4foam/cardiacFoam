# cartesianConvergence - monodomainPseudoECG

## Purpose
This study validates spatial convergence on structured hexahedral (cartesian) meshes using the monodomainPseudoECG exact solution.
