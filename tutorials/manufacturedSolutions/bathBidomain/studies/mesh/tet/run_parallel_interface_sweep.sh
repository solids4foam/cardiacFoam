...
do
    ...
    BANK="studies/mesh/tet/interfaceMeshBank/N$N"
    rm -rf "$BANK"
    mkdir -p "$BANK"
    ...
    do
        ...
        then
            OUT_DIR="studies/mesh/tet/interfaceStudy/$method/N$N"
        else
            OUT_DIR="studies/mesh/tet/interfaceStudy/$ASSEMBLY/$method/N$N"
        fi
        rm -rf "$OUT_DIR"
        mkdir -p "$OUT_DIR"
        ...
        cp studies/mesh/tet/results/N$N/log.checkMesh "$OUT_DIR/"
