...
do
    ...
    BANK="setup/interfaceMeshBank/N$N"
    rm -rf "$BANK"
    mkdir -p "$BANK"
    ...
    do
        ...
        then
            OUT_DIR="setup/interfaceStudy/$method/N$N"
        else
            OUT_DIR="setup/interfaceStudy/$ASSEMBLY/$method/N$N"
        fi
        rm -rf "$OUT_DIR"
        mkdir -p "$OUT_DIR"
        ...
        cp setup/results/N$N/log.checkMesh "$OUT_DIR/"
