...
```text
tutorials/manufacturedSolutions/singleCellMonodomain/
├── constant/
│   ├── electroProperties
│   ├── physicsProperties
│   └── sweepCurrents
...
```bash
applications/scripts/driverFoam/bin/driverFoam all --tutorial singleCell --config tutorials/manufacturedSolutions/singleCellMonodomain/setupSingleCell/driver_config.json
```
