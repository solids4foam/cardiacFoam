...
`nNonOrthogonalCorrectors = 0,1`. They use this case's own `studies/mesh/tet/`
...
```bash
bash tutorials/manufacturedSolutions/bidomain/studies/mesh/tet/studies/corrector/run_corrector_study.sh
```
